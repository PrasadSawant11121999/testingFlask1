    ...
    function addNodeToDrawFlow(name, pos_x, pos_y) {
      ...
      switch (name) {
        ...
        case 'log':
            var log = `
            <div>
              <div class="title-box"><i class="fas fa-file-signature"></i> manish </div>
            </div>
            `;
          ...
          case 'dbclick':
            ...
            case 'JobHeader':
                var JobHeader = `
                <div class="jobheader">
                    <div class="title-box "> Job Header</div>
                </div>
                `;
                editor.addNode('jobheader', 1, 0, pos_x, pos_y, 'jobheader', {}, JobHeader);
                break;
            case 'JobHeaderi':
                var JobHeaderi = `
                <div>
                    <div class="title-box JobHeaderi"> Job Headeri</div>
                ...
                `;
                editor.addNode('JobHeaderi', 0, 1, pos_x, pos_y, 'JobHeaderi', {}, JobHeaderi);
                break;
        default:
      }
    }
